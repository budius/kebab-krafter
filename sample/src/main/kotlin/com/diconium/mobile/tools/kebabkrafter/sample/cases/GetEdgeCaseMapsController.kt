...
class GetEdgeCaseMapsController : GetEdgeCaseMaps {
    override suspend fun CallScope.execute(): MapResponse = MapResponse(
...
fun Route.installGetEdgeCaseMaps() {
    installCaseMapsGeneratedRoutes(
        object : ServiceLocator {
            override fun <T : Any> RoutingContext.getService(type: KClass<T>): T = GetEdgeCaseMapsController() as T
        },
    )
}
